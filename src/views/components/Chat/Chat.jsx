...
export default function Chat(props) {
    ...
    return (
        ...
        <Card>
            ...
            <Card.Body>
                {chat.map(message => <Row><Col xl={4}><p>{message.name}:</p></Col><Col><Card><p>{message.message}</p></Card></Col></Row>)}
            </Card.Body>
            <Card.Footer>
            <InputGroup className="mb-3">
                ...
                />
                <InputGroup.Append>
                    <Button onClick={(e) => handleCreateMessage(e)} variant="dark">Send</Button>
                </InputGroup.Append>
            </InputGroup>
            </Card.Footer>
